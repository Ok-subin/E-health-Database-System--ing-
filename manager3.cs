...
namespace e_health
{
    public partial class manager3 : Form
    {
        ...
        public manager3()
        {
            ...
            // 등록된 의료진 이름 찾기
            string query = "select client_name from totaluser_table where client_mode = 3";
            ...
            query = "select client_id from totaluser_table where client_mode = 3";
            ...
            query = "select client_number from totaluser_table where client_mode = 3";
            cmd = new MySqlCommand(query, connection);
            myReader = cmd.ExecuteReader();
